...
void highestValue(float array_A[], float array_B[], float array_C[], int size)
{
    int i;
    float low_A = 0;
    float low_B = 0;
    ...
    cout << "high in 1st array == " << low_A << endl;
    ...
    cout << "high in 2nd array == " << low_B << endl;
    ...
    cout << "high in 3rd array == " << low_C << endl << endl;
